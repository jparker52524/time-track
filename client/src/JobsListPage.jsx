...
function JobsListPage({ user }) {
    ...
    const [jobAmount, setJobAmount] = useState(null);
    ...
    <div className="jobsListPage">
            ...
            {jobsList
                ...
                return (
                    ...
                    <li>
                        ...
                        {user.is_admin && (
                        <button  className="job-list-edit-btn"
                            onClick={(e) => {
                            e.preventDefault();
                            e.stopPropagation();
                            ...
                            setJobDueDate(job.due_date ? job.due_date.slice(0, 10) : "");
        ...
        >
          <div className="jobs-list-modal-input-container">
            ...
            <button onClick={handleEditJob} className="jobs-list-modal-button">Save</button>
          </div>
        </Modal>
    </div>
    );
